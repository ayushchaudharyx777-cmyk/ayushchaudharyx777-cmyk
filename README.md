...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=ayushchaudharyx777-cmyk&color=8B5CF6&style=for-the-badge&label=PROFILE+VIEWS" alt="Profile views"/>
  &nbsp;
  <img src="https://img.shields.io/badge/Open%20to-Internships-06B6D4?style=for-the-badge&logo=handshake&logoColor=white"/>
  &nbsp;
  <img src="https://img.shields.io/badge/2nd%20Year-B.Tech%20CSE%20AI%26ML-7C3AED?style=for-the-badge&logo=graduation-cap&logoColor=white"/>
</p>
...
<p align="center">
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:8B5CF6,50:06B6D4,100:7C3AED&height=3" width="100%"/>
</p>
...
- 👋 Hey, I'm **Ayush** — a second-year **B.Tech CSE (AI & ML)** student at **SRM Institute of Science and Technology, KTR**, building my foundations in CS, AI, and ML.
- 🔨 Not here for just a degree on paper — I care about *building* things, breaking them, fixing them, and understanding how they work under the hood.
- 📚 Right now: grinding **DSA** daily, learning **Python deeply**, and studying the math powering **ML models**.
- 🤖 Biggest personal project: **JARVIS** — a personal AI assistant built completely from scratch. Custom GUI, voice interaction, local LLMs, full productivity suite — because reading about AI only gets you so far; building it teaches you the rest.
...
```
┌─────────────────────────────────────────────────────────────────┐
│  🧩  DSA & Problem Solving     →  Building interview readiness  │
│  🐍  Python & ML Math          →  Deepening core knowledge      │
│  🏗️  System Architecture       →  Understanding how scale works │
│  🤖  JARVIS (personal project) →  Learning by building          │
└─────────────────────────────────────────────────────────────────┘
```
...
A fully custom Python-powered personal AI assistant — not a wrapper around an API, but a real desktop system built piece by piece from scratch. Runs on a **local LLM (Ollama)** for offline, private AI responses. Full voice interaction, animated custom GUI, and a complete productivity dashboard built in.

<details>
  <summary><b>🛠️ View Technical Features & Integrations</b></summary>
  <br>
  <ul>
    <li>🖥️ Custom GUI with <b>CustomTkinter</b> — animated startup sequence, cinematic dark aesthetic with particle effects.</li>
    <li>🧩 Local LLM via <b>Ollama (llama3.2)</b> — fully offline, zero API costs, private.</li>
    <li>🗣️ Voice I/O via <b>speech recognition</b> + <b>pyttsx3 / ElevenLabs</b> TTS.</li>
    <li>🎵 Optional integrations: <b>Spotify</b>, <b>OpenCV</b> (webcam), <b>Flask</b> (LAN server), <b>librosa</b> (voice emotion analysis).</li>
    <li>⚙️ 15+ built-in tools: Pomodoro, clipboard manager, code executor, habit tracker, unit converter, QR/password generator, network scanner, screenshot OCR, process killer, weather alerts, CPU/RAM monitor, hotkey overlay.</li>
  </ul>
</details>

#### 🏎️ Redline Labs — F1 Engine Room Simulator

A single-file HTML/CSS/JS F1 racing simulator featuring 10 F1 teams with 2025/2026 data, animated SVG cars, particle systems, ghost lap system, track selector, pit stop simulator, team radio popup, drag race mode, and live race standings.

> *More projects incoming as I build out my GitHub portfolio 🌱*
...
<img src="https://img.shields.io/badge/Flask-06B6D4?style=for-the-badge&logo=flask&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Jupyter-4E4E4E?style=for-the-badge&logo=jupyter&logoColor=F37626"/>
...
`Python` &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![](https://progress-bar.xyz/75/?width=200&color=8B5CF6)

`DSA / Problem Solving` &nbsp;&nbsp;&nbsp; ![](https://progress-bar.xyz/60/?width=200&color=06B6D4)

`Machine Learning` &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![](https://progress-bar.xyz/45/?width=200&color=7C3AED)

`C++` &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![](https://progress-bar.xyz/55/?width=200&color=8B5CF6)

`Git & GitHub` &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![](https://progress-bar.xyz/65/?width=200&color=06B6D4)

`Web (HTML/CSS/JS)` &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![](https://progress-bar.xyz/50/?width=200&color=7C3AED)
...
<p align="center">
<a href="https://linkedin.com/in/ayush-chaudhary-890bba294" target="_blank">
